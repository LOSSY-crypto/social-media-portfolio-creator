...
const Hero = () => {
  ...
  return <section id="home" className="min-h-screen flex items-center pt-16 relative overflow-hidden">
      {/* Background Elements */}
      ...
      <div className="container-custom relative z-10">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          <div className={`space-y-6 ${isLoaded ? 'opacity-100' : 'opacity-0'} transition-opacity duration-1000`}>
            ...
            <h1 className="heading-xl opacity-0 animate-fade-in-up" style={{
            ...
            <p className="paragraph max-w-xl opacity-0 animate-fade-in-up" style={{
            ...
            <div className="flex flex-wrap gap-4 pt-4 opacity-0 animate-fade-in-up" style={{
            ...
            <div className="pt-8 opacity-0 animate-fade-in-up" style={{
