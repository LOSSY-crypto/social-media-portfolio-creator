...
const Contact = () => {
  ...
  const handleSubmit = (e: React.FormEvent) => {
    ...
    setTimeout(() => {
      setLoading(false);
      toast.success("Thank you for your message! I'll respond shortly.");
      setFormData({
        name: "",
        email: "",
        subject: "",
      ...
      <div className="container-custom">
        <div className="max-w-3xl mx-auto text-center mb-16">
          ...
          <p className="paragraph opacity-0 animate-fade-in-up" style={{animationDelay: '300ms', animationFillMode: 'forwards'}}>
            Ready to elevate your social media presence? Let's discuss how I can help your brand thrive in the digital landscape.
          </p>
        </div>

        <div className="grid grid-cols-1 lg:grid-cols-3 gap-10">
          <div className="lg:col-span-1 opacity-0 animate-fade-in-left" style={{animationDelay: '500ms', animationFillMode: 'forwards'}}>
            <div className="glass-card rounded-2xl p-8 h-full">
              <h3 className="heading-sm text-2xl mb-6">Contact Information</h3>
              ...
              <div className="mt-10">
                ...
                <div className="flex space-x-3">
                  ...
                  <a
                    href="#"
                    className="p-2 rounded-full bg-social-facebook/10 text-social-facebook hover:bg-social-facebook hover:text-white transition-colors"
                    aria-label="Facebook"
                  >
                    <svg
                      className="w-5 h-5"
                  ...
                  <a
                    href="#"
                    className="p-2 rounded-full bg-social-twitter/10 text-social-twitter hover:bg-social-twitter hover:text-white transition-colors"
                    aria-label="Twitter"
                  >
                    <svg
                      className="w-5 h-5"
          ...
          <div className="lg:col-span-2 opacity-0 animate-fade-in-right" style={{animationDelay: '700ms', animationFillMode: 'forwards'}}>
            <div className="glass-card rounded-2xl p-8">
              <h3 className="heading-sm text-2xl mb-6">Send a Message</h3>
